...
namespace Carrito_PNT1.Controllers
{
    public class CarritosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CarritoId,Activo,ClienteId")] Carrito carrito)
        {
            ...
            ViewData["ClienteId"] = new SelectList(_context.Cliente, "UsuarioId", "Apellido", carrito.ClienteId);
            return View(carrito);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarritoId,Activo,ClienteId")] Carrito carrito)
        {
